<template>
  <article class="document-page fade-in">
    <div class="document-header" v-if="page">
      ...
      <NuxtLink to="/case-studies" class="back-link">← Back to Case Studies</NuxtLink>
    </div>
...
const { data: page } = await useAsyncData(route.path, () => queryCollection('caseStudies').path(route.path).first())
</script>
